...
// Esse arquivo utiliza do Wokwi com o broker padrão (test.mosquitto.org). Caso queira utilizar do broker HiveMQ (broker.hivemq.com), é necessário "comentar" a linha 25 e apagar as barras (//) dos comentários nas linhas: 26, 121, 122 e 157.
